...
```json
{
  "teambit.generator/generator": {
    "envs": [
      "reeds.extensions/envs/my-react-env"
    ]
  }
}
```
...
```
bit env set my-component reeds.extensions/envs/my-react-env
```
...
```
bit new react my-workspace --aspect reeds.extensions/envs/my-react-env
```
